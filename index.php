...
================================================== -->
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color: dark-blue;">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><img src="images/crop2.png" alt=""  style="height: 60px; width: 80px;"><h6 style="color: white;">Guarantee international ltd</h6></a>
            </div>
        ...
        <div id="main-slide" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                        <img class="img-responsive" src="images/code.jpg" alt="slider">
                ...
                <div class="item">
                    <img class="img-responsive" src="images/books.jpg" alt="slider">
                    
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated1">
                    		  <span> Quality <strong> Education</strong></span>
                    	    </h1>
                ...
                <div class="item">
                    <img class="img-responsive" src="images//travel1.jpg" alt="slider">
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated2" style="color:#00008b;">
                                <span>Travel safe With us</span>
                            </h1>
                ...
                <div class="item">
                    <img class="img-responsive" src="images//job2.jpg" alt="slider">
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated2" style="color:#00008b;">
                ...
                <!-- <div class="item">
                    <img class="img-responsive" src="images/passport.png" alt="slider">
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="animated2">Develop a passion for learning.<br> An investment in knowledge pays the best interest</p>
                ...
                <div class="item">
                    <img class="img-responsive" src="images/job.jpg" alt="slider">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="feature-2">
                            <div class="media">
                                <div class="pull-left">
                                    <a href="study.php"><i class="fa fa-magic"></i></a>
                                    <div class="border"></div>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="feature-2">
                            <div class="media">
                                <div class="pull-left">
                                    <a href="visa.php"><i class="fa fa-css3"></i></a>
                                    <div class="border"></div>
                                </div>
                                <div class="media-body">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="feature-2">
                            <div class="media">
                                <div class="pull-left">
                                    <a href="job.php"><i class="fa fa-joomla"></i></a>
                                    <div class="border"></div>
                                </div>
                                <div class="media-body">
